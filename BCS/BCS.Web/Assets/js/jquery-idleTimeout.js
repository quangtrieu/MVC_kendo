...
(function ($) {
  ...
  $.fn.idleTimeout = function (userRuntimeConfig) {
    ...
    startIdleTimer = function () {
      ...
      store.set('sessionTimeOut', false);
    ...
    openWarningDialog = function () {
      ...
      //    title: 'Edit Schedule of ' ,
      //    height: 500,
      //    //width: 1024,
      //    id: "editSchedulePopup"
      //});

      //setaJs.initFormWindow("#idletimer_warning_dialog", popupWindow,null, function (response) {
      //}, function (jqXHR, textStatus, errorThrown) {
      //    $("#errorsArea").append("<h5>" + errorThrown + "</h5>");
      //});

      var options = {
          id: 'idletimer_warning_dialog',
          title: currentConfig.dialogTitle,
          width: 690
      };
      var popupWindow = setaJs.initPopupWindow(options,function() {
    ...
    destroyWarningDialog = function () {
        ...
        var options = {
            id: 'idletimer_warning_dialog',
            title: 'Switch to supported Restaurant',
            width: 690
        };
        var popupWindow = setaJs.initPopupWindow(options, function () {
        });
...
jQuery("#idletimer_warning_dialog").hide();